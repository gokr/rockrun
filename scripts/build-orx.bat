...
REM  orxBuild.h is generated by ORX's setup script; without it the headers
REM  do not compile. An empty file is all the build needs.
if not exist "%BUILD_ROOT%\norx\orx\code\include\base\orxBuild.h" (
    echo Creating orxBuild.h...
    type nul > "%BUILD_ROOT%\norx\orx\code\include\base\orxBuild.h"
)
